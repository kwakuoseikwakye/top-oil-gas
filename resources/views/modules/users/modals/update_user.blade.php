<!-- Modal-->
<div class="modal fade" id="update-user-modal" tabindex="-1" role="dialog" aria-labelledby="staticBackdrop"
    aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="update-user-form" enctype="multipart/form-data">
                    ...
                    <input type="text" name="transid" id="update-user-transid" required hidden>
                    <div class="row mt-3">
                        <div class="col">
                            <label for="">First Name <span class="text-danger">*</span></label>
                            <input type="text" name="fname" placeholder="John" class="form-control form-control-sm"
                                id="update-user-fname" required>
                        </div>
                    ...
                    <div class="row mt-3">
                        <div class="col">
                            ...
                            <input type="email" name="email" placeholder="john@example.com"
                                class="form-control form-control-sm" id="update-user-email" required>
                        </div>
                        <div class="col">
                            <label for="">Phone <span class="text-danger">*</span></label>
                            <input type="text" min="10" name="phone" placeholder="0555555555"
                                class="form-control form-control-sm" id="update-user-phone" required>
                        </div>
                    </div>
                    ...
                    <div class="row mt-3">
                        <div class="col">
                            ...
                            <select name="usertype" class="form-control select2" id="update-user-usertype" required>
            ...
            <div class="modal-footer">
                ...
                <button type="submit" form="update-user-form" class="btn btn-primary font-weight-bold">Save</button>
            </div>
        </div>
    </div>
</div>
