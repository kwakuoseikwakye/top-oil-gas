<div class="modal fade" id="print-return-modal" tabindex="-1" role="dialog" aria-labelledby="staticBackdrop"
    aria-hidden="true">
    <div class="modal-dialog modal-md modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Print Return Form</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <i aria-hidden="true" class="ki ki-close"></i>
                </button>
            </div>
            <div class="modal-body">
                <form id="print-return-form">
                    @csrf
                    @php
                    ...
                    <div class="row mt-3">
                        <div class="col">
                            ...
                            <select name="vendor" id="select-r" class="form-control select2" required>
            ...
            <div class="modal-footer">
                ...
                <button type="submit" form="print-return-form" class="btn btn-primary font-weight-bold">Search</button>
            </div>
        </div>
    </div>
</div>
<script>
    ...
    var returnPrintForm = document.getElementById("print-return-form");

    $(returnPrintForm).submit(function (e) {
        e.preventDefault();

        let formdata = new FormData(returnPrintForm)
        ...
        fetch(`${APP_URL}/api/print_return`, {
            method: "POST",
            body: formdata,
        }).then(function (res) {
            return res.json()
            ...
            var printReturnCylinderTable = document.getElementById("print-return-cylinder-tbl")
            // var printDispatchCylinderTable = document.getElementById("print-return-cylinder-id")

            printReturnCylinderTable.innerHTML = null;
            // printDispatchCylinderTable.innerHTML = null;

            let dispatch = data.data;
            document.getElementById("return-return-to").innerText = dispatch[0].vfname + ' ' +
            dispatch[0].vmname+ ' ' + dispatch[0].vlname;
            document.getElementById("return-return-to-phone").innerText = dispatch[0].phone;
            document.getElementById("return-location").innerText = dispatch[0].location;
            ...
            dispatch.forEach(element => {
                ...
                printReturnCylinderTable.appendChild(tRow);
                ...
                // printDispatchCylinderTable.appendChild(dRow);

            });

            $("select").val(null).trigger('change');
            returnPrintForm.reset();
            $("#print-return-modal").modal('hide');
            $("#vendor-return-modal").modal('show');
