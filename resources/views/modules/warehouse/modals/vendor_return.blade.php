<div class="modal fade" id="vendor-return-modal" tabindex="-1" role="dialog" aria-labelledby="staticBackdrop"
    aria-hidden="true">
    <div class="modal-dialog modal-lg" style="min-width: 95%" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Daily Return</h5>
                        ...
                        <table class="table table-bordered print-dispatch">
                            <thead>
                                <tr>
                                    ...
                                    <th style="border-right: 2px solid black !important; border-bottom: 2px solid black !important;" scope="col" id="return-date">{{date("Y-m-d, H:i:s A")}} </th>
                                    <th style="border-right: 2px solid black !important; border-bottom: 2px solid black !important;" scope="col ">LCX No.</th>
                                    <th style="border-right: 2px solid black !important; border-bottom: 2px solid black !important;" scope="col" id="return-location"></th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr>
                                    <th style="border-right: 2px solid black !important; border-bottom: 2px solid black !important;" scope="col">Name Operator</th>
                                    <th style="border-right: 2px solid black !important; border-bottom: 2px solid black !important;" scope="col" id="return-return-to"></th>
                                    <th style="border-right: 2px solid black !important; border-bottom: 2px solid black !important;" scope="col">TEL</th>
                                    <th style="border-right: 2px solid black !important; border-bottom: 2px solid black !important;" scope="col" id="return-return-to-phone"></th>
                                </tr>
                            </tbody>
                        </table>
                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                ...
                                <table class="table table-bordered print-dispatch">
                                    ...
                                    <tbody id="print-return-cylinder-tbl">
