                ...
                <form id="add-customer-form" enctype="multipart/form-data">
                    ...
                    <div class="row mt-3">
                        <div class="col">
                            ...
                            <select name="gender" class="form-control select2" id="add-customer-gender" required>
                        ...
                        <div class="col">
                            ...
                            <input type="email" name="email" placeholder="john@example.com"
                                class="form-control form-control-sm" id="add-customer-email" required>
                        </div>
                        <div class="col">
                    ...
                    <div class="row mt-3">
                        <div class="col">
                            ...
                            <select name="title" class="form-control select2" id="add-customer-title" required>
                        ...
                        <div class="col">
                            ...
                            <input type="date" name="dateOfBirth" placeholder="Doe" class="form-control form-control-sm"
                                id="add-customer-dob" required>
                        </div>

                        <div class="col">
                            <label for="">Marital Status <span class="text-danger">*</span></label>
                            <select name="maritalStatus" class="form-control select2" id="add-customer-marital"
                                required>
                    ...
                    <div class="row mt-3">
                        <div class="col">
                            ...
                            <select name="region" class="form-control select2" id="add-customer-region" required>
                        ...
                        <div class="col">
                            ...
                            <input type="text" name="town" class="form-control form-control-sm" id="add-customer-town"
                                required>
                        </div>
                        <div class="col">
                            ...
                            <input type="text" name="homeAddress" class="form-control form-control-sm"
                                id="add-customer-address" required>
                        </div>
                    </div>
                    ...
                    <div class="row mt-3">
                        <div class="col">
                            ...
                            <select name="idType" class="form-control select2" id="add-customer-idtype" required>
                        ...
                        <div class="col">
                            ...
                            <input type="text" name="placeOfBirth" placeholder="John"
                                class="form-control form-control-sm" id="add-customer-fname">
                        </div>
                    </div>
