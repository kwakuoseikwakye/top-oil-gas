                    ...
                    <div class="row mt-3">
                        <div class="col">
                            ...
                            <input type="text" name="latitude" class="form-control form-control-sm"
                                id="edit-vendor-lat" required>
                        </div>
                        <div class="col">
                            <label for="">ID Type <span class="text-danger">*</span></label>
                            <select name="idType" class="form-control select2" id="edit-vendor-idtype" required>
